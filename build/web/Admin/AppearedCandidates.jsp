<%-- 
    Document   : AppearedCandidates
    Created on : May 8, 2015, 2:35:50 PM
    Author     : eshangill
--%>
...
<html>
    <head>
        ...
        <title>WebXam Appeared Candidates</title>
        ...
        <div id="ContentWrapper"> 
            ...
            <div id="RightDiv">
                <%
                        ...
                        ArrayList<Beans.Report> AR = objDAL.getAppearedCandidates(Integer.parseInt(request.getParameter("TIDAC")));
                %>
                     <div id="ScrollDiv">
                    <table border="2"> 
                             <tr>
