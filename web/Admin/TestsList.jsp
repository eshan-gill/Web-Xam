<%-- 
    Document   : TestList
    Created on : Apr 6, 2015, 11:04:06 PM
    Author     : eshangill
--%>
    ...
    <body>
        ...
        <div id="ContentWrapper"> 
            ...
            <div id="RightDiv">
                ...
                %>
                <form action="TestsList.jsp" name="frmTestsList">
                    Department:&nbsp; 
                    ...
                    <table border="2"> 
                             ...
                             <tr>
                                 ...
                                 <td class="TData"> 
                                     <a href="Test.jsp?TIDE=<%=T.getTestId() %>">Edit</a> 
                                 </td>
                                 <td class="TData"> 
                                     <a href="TestDel.jsp?TIDD=<%=T.getTestId() %>">Delete</a> 
                                 </td>
                                 <td class="TData"> 
                                     <a href="TestCategories.jsp?TIDC=<%=T.getTestId() %>">Categories</a> 
                                 </td>
                                 <td class="TData"> 
                                     <a href="Instructions.jsp?TIDI=<%=T.getTestId() %>">Instructions</a> 
                                 </td>
                             </tr>
                             <%}}%>
                     </table>
